...
import { ServiceAgentHistory, ServiceMultisigHistory, AgentMultisigHistory } from "../generated/schema";
...
// Helper function to process both execution success events
function processExecution(event: ethereum.Event): void {
  ...
  if (multisig != null) {
    ...
    if (historicalData != null) {
      ...
      if (service != null) {
        ...
        // Restore agentIds to the latest state. This is not strictly necessary
        // as we don't save the multisig entity here, but it's good practice.
