...
// Legacy exports for compatibility - using placeholder addresses until feeds are available
export const ETH_USD_FEED = Address.fromString("0x0000000000000000000000000000000000000001") // TODO: Add MODE ETH/USD feed
export const USDC_USD_FEED = Address.fromString("0x0000000000000000000000000000000000000002") // TODO: Add MODE USDC/USD feed
